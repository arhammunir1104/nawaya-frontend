  ...
  return (
    <section className="bg-GrayBg pt-20 overflow-hidden">
      ...
      <div className="xs:mt-10 lg:mt-16 xs:mb-5 lg:mb-0 mx-auto xs:w-full xl:w-[1050px] relative">
        <img src={Banner} className="relative z-2 xs:hidden lg:inline lg:relative lg:w-full lg:h-auto " />
        <img src={Banner1} className="relative z-2 xs:inline xs:w-full xs:h-full lg:hidden" />
